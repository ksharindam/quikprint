...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.reverseBtn = QtGui.QCheckBox(self.groupBox)
        ...
        self.reverseBtn.setObjectName(_fromUtf8("reverseBtn"))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_3.setText(_translate("Dialog", "Page Ranges :", None))
        self.reverseBtn.setText(_translate("Dialog", "Reverse", None))
