...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        icon = QtGui.QIcon.fromTheme(_fromUtf8("gtk-cancel"))
        self.quitBtn.setIcon(icon)
        self.quitBtn.setIconSize(QtCore.QSize(24, 24))
        ...
        self.printBtn.setIconSize(QtCore.QSize(24, 24))
